...
import { PutApiService } from "./put-api-service/put-api-service";

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, HostListenerExample, PreserverWhitespaceExample, EncapsulationFirst, Parent, Super, IfDirectives, SwitchCaseDirective, ForDirective, NgClassDirective, NgStyle, Interpolation, ErrorHandlingInterpolation, AttributeBinding, StyleBinding, ClassBinding, PropertyBinding, EventBinding, TwoWayBinding, BuiltInPipes, CustomPipe, InjectableService, GetApiMethod, PostApiService, DeleteApiService, PutApiService],
